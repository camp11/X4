...
$channelAccessToken = 'xoJM3ks2frhpxwOTqEVaXcBRID+fJ4+SATmO1RxjLebeOe/gE4VztqsmYJYelrjbk6SHqgEJDzLJ5GqcUWXkHkNVfI1DHAln/U9gOx643gsoy2M0rUPUOxS3HnLOrdQGllJFXNFbmW5/DpGlGlN6TgdB04t89/1O/w1cDnyilFU='; //sesuaikan 
$channelSecret = '98b16179968575fe51f61582c89c2f7e';//sesuaikan
...
if($message['type']=='text') {
        ...
        $balas = array(
            ...
            'messages' => array(
                array(
                    'type' => 'text',
                    'text' => 'Pagi juga,Sobat DMS1, Senyum ya! '.$profil->displayName
                )
            )
        );
    }
...
if($message['type']=='text') {
        ...
        $balas = array(
            ...
            'messages' => array(
                array (
  'type' => 'imagemap',
  'baseUrl' => 'https://res.cloudinary.com/dmvpko25b/image/upload/v1532240484/DMS1/WELCOME',
  'altText' => 'WELCOME TO DMS1 Family Room',
  'baseSize' => 
  array (
    'height' => 1040,
    'width' => 1040,
  ...
  array (
    ...
    array (
      'type' => 'uri',
      'linkUri' => 'https://www.smule.com/BASE_DMS1',
      'area' => 
      array (
        'x' => 0,
        'y' => 0,
...
if($message['type']=='text') {
  ...
  array (
    ...
    array (
      0 => 
      array (
        'imageUrl' => 'https://res.cloudinary.com/dmvpko25b/image/upload/v1532241141/DMS1/ADMIN/1532233074974.jpg',
        'action' => 
        array (
          'type' => 'uri',
          'label' => 'SMULE',
          'uri' => 'http://smule.com/DMS1_4YUNI',
        ),
      ),
      1 => 
      array (
      ...
      array (
        ...
        array (
          'type' => 'uri',
          'label' => 'SMULE',
          'uri' => 'http://smule.com/Nania_Dms1Bmi',
        ),
      ),
      3 => 
      array (
        'imageUrl' => 'https://res.cloudinary.com/dmvpko25b/image/upload/v1532241141/DMS1/ADMIN/1532233113627.jpg',
        'action' => 
        array (
          'type' => 'uri',
          'label' => 'SMULE',
          'uri' => 'http://smule.com/DMS1_DHITA1674',
        ),
      ),
      4 => 
      array (
        'imageUrl' => 'https://res.cloudinary.com/dmvpko25b/image/upload/v1532241141/DMS1/ADMIN/1532233124869.jpg',
        'action' => 
        array (
          'type' => 'uri',
          'label' => 'SMULE',
          'uri' => 'http://smule.com/SC_QU3N_DMS1',
        ),
      ),
      5 => 
      array (
        'imageUrl' => 'https://res.cloudinary.com/dmvpko25b/image/upload/v1532241142/DMS1/ADMIN/1532233149483.jpg',
        'action' => 
        array (
          'type' => 'uri',
          'label' => 'SMULE',
          'uri' => 'http://smule.com/DMS1_zirwan_EXS1',
        ),
      ),
      6 => 
      array (
        'imageUrl' => 'https://res.cloudinary.com/dmvpko25b/image/upload/v1532241143/DMS1/ADMIN/1532233137043.jpg',
        'action' => 
        array (
          'type' => 'uri',
          'label' => 'SMULE',
          'uri' => 'http://smule.com/DMS1_SHIMPONY',
        ),
      ),
    ),
  ),
